...
public class UpDownTextView extends LinearLayout {
    ...
    private void initViews() {  
        ...
        textViews[1].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(),mTextList.get(currentIndex),Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void startAutoScroll() {  
        if (!isRunning) {  
            ...
            this.postDelayed(runnable, 0);// 可用runnable来代替hander或者 timer
        }  
    }  
...
//            LogUitls.print("滚动文本", "界面滚动");  
    ...
    public void setTextList(List<String> mTextList) {
        String temp = mTextList.get(mTextList.size() - 1);
        mTextList.remove(mTextList.size()-1);
        mTextList.add(0,temp);
